...
public interface MetaModelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EVOLUTION_STYLE__MEMBERS = 1;
	 ...
	 * @ordered
	 */
	int EVOLUTION_STYLE_FEATURE_COUNT = 2;
	...
	/**
	 * The meta object id for the '{@link MetaModel.impl.PathImpl <em>Path</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see MetaModel.impl.PathImpl
	 * @see MetaModel.impl.MetaModelPackageImpl#getPath()
	 * @generated
	 */
	int PATH = 1;
	 ...
	 * @ordered
	 */
	int PATH__INITIAL_ARCHITECTURE = 3;
	 ...
	 * @ordered
	 */
	int PATH__FINAL_ARCHITECTURE = 4;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link MetaModel.EvolutionStyle#getMembers <em>Members</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Members</em>'.
	 * @see MetaModel.EvolutionStyle#getMembers()
	 * @see #getEvolutionStyle()
	 * @generated
	 */
	EReference getEvolutionStyle_Members();

	/**
	 * Returns the meta object for class '{@link MetaModel.Path <em>Path</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link MetaModel.Path#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see MetaModel.Path#getName()
	 * @see #getPath()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link MetaModel.Path#getTransitions <em>Transitions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Transitions</em>'.
	 * @see MetaModel.Path#getTransitions()
	 * @see #getPath()
	 * @generated
	 */
	EReference getPath_Transitions();

	/**
	 * Returns the meta object for the containment reference list '{@link MetaModel.Path#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>States</em>'.
	 * @see MetaModel.Path#getStates()
	 * @see #getPath()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link MetaModel.Path#getInitialArchitecture <em>Initial Architecture</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Initial Architecture</em>'.
	 * @see MetaModel.Path#getInitialArchitecture()
	 * @see #getPath()
	 * @generated
	 */
	EReference getPath_InitialArchitecture();

	/**
	 * Returns the meta object for the reference '{@link MetaModel.Path#getFinalArchitecture <em>Final Architecture</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Final Architecture</em>'.
	 * @see MetaModel.Path#getFinalArchitecture()
	 * @see #getPath()
	 * @generated
	 */
	EReference getPath_FinalArchitecture();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference EVOLUTION_STYLE__MEMBERS = eINSTANCE.getEvolutionStyle_Members();

		/**
		 * The meta object literal for the '{@link MetaModel.impl.PathImpl <em>Path</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see MetaModel.impl.PathImpl
		 * @see MetaModel.impl.MetaModelPackageImpl#getPath()
		 ...
		 * @generated
		 */
		EReference PATH__TRANSITIONS = eINSTANCE.getPath_Transitions();
		 ...
		 * @generated
		 */
		EReference PATH__INITIAL_ARCHITECTURE = eINSTANCE.getPath_InitialArchitecture();
		 ...
		 * @generated
		 */
		EReference PATH__FINAL_ARCHITECTURE = eINSTANCE.getPath_FinalArchitecture();
