...
public class MetaModelPackageImpl extends EPackageImpl implements MetaModelPackage {
	 ...
	 * @generated
	 */
	private EClass evolutionStyleEClass = null;
	 ...
	 * @generated
	 */
	private EClass intermidiateStateEClass = null;
	 ...
	 * @generated
	 */
	public EClass getEvolutionStyle() {
		return evolutionStyleEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getEvolutionStyle_Name() {
		return (EAttribute)evolutionStyleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getEvolutionStyle_Members() {
		return (EReference)evolutionStyleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getPath_Transitions() {
	 ...
	 * @generated
	 */
	public EReference getPath_InitialArchitecture() {
	 ...
	 * @generated
	 */
	public EReference getPath_FinalArchitecture() {
	 ...
	 * @generated
	 */
	public EReference getTransition_Operations() {
	 ...
	 * @generated
	 */
	public EAttribute getOperation_Cost() {
	 ...
	 * @generated
	 */
	public EAttribute getOperation_Time() {
	...
	public void createPackageContents() {
		...
		createEReference(evolutionStyleEClass, EVOLUTION_STYLE__MEMBERS);

		pathEClass = createEClass(PATH);
		createEAttribute(pathEClass, PATH__NAME);
		createEReference(pathEClass, PATH__TRANSITIONS);
		createEReference(pathEClass, PATH__STATES);
		createEReference(pathEClass, PATH__INITIAL_ARCHITECTURE);
		createEReference(pathEClass, PATH__FINAL_ARCHITECTURE);

		transitionEClass = createEClass(TRANSITION);
		createEAttribute(transitionEClass, TRANSITION__NAME);
		createEAttribute(transitionEClass, TRANSITION__DESCRIPTION);
		createEReference(transitionEClass, TRANSITION__OPERATIONS);
		createEReference(transitionEClass, TRANSITION__SOURCE);
		createEReference(transitionEClass, TRANSITION__TARGET);

		operationEClass = createEClass(OPERATION);
		createEAttribute(operationEClass, OPERATION__NAME);
		createEAttribute(operationEClass, OPERATION__COST);
		createEAttribute(operationEClass, OPERATION__TIME);
	...
	public void initializePackageContents() {
		...
		intermidiateStateEClass.getESuperTypes().add(this.getState());
		...
		initEReference(getEvolutionStyle_Members(), this.getPath(), null, "members", null, 0, -1, EvolutionStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPath_Transitions(), this.getTransition(), null, "transitions", null, 1, -1, Path.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPath_States(), this.getState(), null, "states", null, 1, -1, Path.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPath_InitialArchitecture(), this.getInitialState(), null, "InitialArchitecture", null, 1, 1, Path.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPath_FinalArchitecture(), this.getFinalState(), null, "FinalArchitecture", null, 1, 1, Path.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransition_Operations(), this.getOperation(), null, "operations", null, 1, -1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOperation_Cost(), ecorePackage.getEFloatObject(), "cost", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperation_Time(), ecorePackage.getEFloatObject(), "time", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
