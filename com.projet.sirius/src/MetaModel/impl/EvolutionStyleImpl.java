 ...
 *   <li>{@link MetaModel.impl.EvolutionStyleImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvolutionStyleImpl extends MinimalEObjectImpl.Container implements EvolutionStyle {
	 ...
	 * @generated
	 */
	public EList<Path> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<Path>(Path.class, this, MetaModelPackage.EVOLUTION_STYLE__MEMBERS);
		}
		return members;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MetaModelPackage.EVOLUTION_STYLE__MEMBERS:
				getMembers().clear();
				getMembers().addAll((Collection<? extends Path>)newValue);
				return;
		}
