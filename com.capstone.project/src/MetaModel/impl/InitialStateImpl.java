...
public class InitialStateImpl extends StateImpl implements InitialState {
		...
		if (next != null && next.eIsProxy()) {
			...
			if (next != oldNext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetaModelPackage.INITIAL_STATE__NEXT, oldNext, next));
			}
		}
		return next;
	}
	...
	public void setNext(State newNext) {
		...
		next = newNext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaModelPackage.INITIAL_STATE__NEXT, oldNext, next));
	}
